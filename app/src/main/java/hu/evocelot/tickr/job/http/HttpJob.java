...
public class HttpJob implements Job {
     ...
     * <p>
     * The method extracts the {@link JobDetails} object from the
     * {@link JobExecutionContext}, retrieves the HTTP method, URL, and request body
     * from the {@link HttpJobDetails}, and uses a {@link RestTemplate} to perform
     * the
    ...
    public void execute(JobExecutionContext context) {
        ...
        HttpJobDetails httpTaskConfig = (HttpJobDetails) context.getJobDetail().getJobDataMap()
